export const ProjectSelect({ projects, register }) {
    const onSelect = () => {
        ...
        if (document.getElementById('ProjectTitle')) {
            ...
            document.getElementById('ProjectDate').value = selectedProject.dateCreated
        }
    }
    ...
    return (
        <li>
            <select id="ProjectId" className="ProjectId" onInput={} defaultValue="default" {...register('id')}>
